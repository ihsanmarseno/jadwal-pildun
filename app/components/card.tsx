...
const Team = ({ team }: TeamProps) => {
  return (
    <div className="flex flex-col w-1/2 items-center justify-center">
      ...
      />
      <p className="font-bold text-lg mt-2 text-center text-[#243656]">
        {team.name}
      </p>
...
const Versus = ({ date }: VersusProps) => {
  return (
    <div className="grid relative h-full py-3">
      ...
      <span className="font-medium text-medium place-self-end bg-[#243656] rounded-full px-3 py-1 text-white">
